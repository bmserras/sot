...
import org.bmserras.sot.events.widget.inner.InnerAddEvent;
import org.vaadin.lineawesome.LineAwesomeIcon;

public class InnerNewCard extends VerticalLayout {
    ...
    public InnerNewCard(Component icon, String title, String tooltipText) {
        setHeightFull();
        ...
        this.mainButton.addClickListener(click -> fireEvent(new InnerAddEvent(this)));
    ...
    public void addMainListener(ComponentEventListener<InnerAddEvent> listener) {
        addListener(InnerAddEvent.class, listener);
    }
}
