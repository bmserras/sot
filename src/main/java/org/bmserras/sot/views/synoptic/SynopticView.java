...
//
//        Select<WidgetOld> selectWidget = new Select<>("Widget", click -> {});
//        selectWidget.setItemLabelGenerator(WidgetOld::getName);
...
//
//            Optional<Synoptic> synoptic = synopticService.findByName(synopticName.getValue());
//            Optional<WidgetOld> widget = widgetService.findByName(selectWidget.getValue().getName());
//            //synoptic.get().addWidget(widget.get(), position.getValue());
//            synopticService.save(synoptic.get());
//
//            if (widget.get() instanceof RadarWidgetOld) {
//                canvas.add(new RadarWidgetComponent(widgetService, (RadarWidgetOld) widget.get()), position.getValue());
//            }
//            else {
//                System.out.println("WHAT???");
//            }
